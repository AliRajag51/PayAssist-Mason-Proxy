...
export default function AboutPage() {
  return (
    <ContentPage eyebrow="Our story" title="A considered home, made simple">
      ...
      <p>
        Every piece we sell is chosen for the long run. We&apos;re not interested in trends, surplus
        runs or rebrand-of-the-week — we&apos;re interested in pieces that age beautifully, that can
        be repaired, and that stay in a home for years rather than seasons.
      </p>
      <h2>What we look for</h2>
      <p>
        Natural materials — stoneware, linen, brass, oak, alabaster, glass. Honest construction.
        Quiet shapes. Soft palettes. A maker behind every piece, with their hand visible in the
        finish.
      </p>
